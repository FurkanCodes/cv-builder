...
export default function PersonalInfoForm() {
  const { cvData, updatePersonalInfo, updateProgress } = useCVData();
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea 
                      placeholder="Experienced software engineer with 5+ years of expertise in designing and implementing scalable applications..." 
                      className="min-h-[120px]"
                      {...field} 
                    />
                  </FormControl>
                  <FormDescription>
                    A brief overview of your professional background and strengths (50-200 words).
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}

...
// Removed: import { DragDropContext, Droppable, Draggable } from "react-beautiful-dnd";
// Removed: import { GripVertical } from "lucide-react"; // GripVertical is only used for drag handle
...
export default function WorkExperienceForm() {
  // Removed reorderSection from useCVData
  const {
    cvData,
    addWorkExperience,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {" "}
        {/* This div replaces the Droppable wrapper */}
        {cvData.workExperience.length > 0 ? (
          <Card>
            <CardHeader>
              <CardTitle>Work Experience</CardTitle>
              {/* Removed CardDescription for drag */}
            </CardHeader>
            <CardContent>
              <Accordion
                type="single"
              ...
              >
                {cvData.workExperience.map(
                  (
                    experience // Removed index from map
                  ) => (
                    // Removed Draggable
                    <div
                      key={experience.id} // Key is now directly on this div
                      className="mb-2"
                      // Removed ref={provided.innerRef}
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center">
                          {/* Removed drag handle div {...provided.dragHandleProps} */}
                          {/* Removed GripVertical */}
      ...
      {/* Removed closing Droppable and DragDropContext */}
